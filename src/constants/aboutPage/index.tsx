            ...
            <ul className="list-disc pl-[2ch]">
              <li>
                <p className="wv-b4 wv-ibmplexlooped text-black">
                  ประการแรกคือการเปิดเผยข้อมูลงบประมาณขององค์กรปกครองส่วนท้องถิ่น
                  (อปท.) ในรูปแบบที่เข้าถึงและเข้าใจได้ง่าย
                  เพื่อให้ประชาชนสามารถรับรู้ว่างบประมาณในพื้นที่ของตนถูกจัดสรรอย่างไร
                </p>
              </li>
              <li>
                <p className="wv-b4 wv-ibmplexlooped text-black">
                  ประการที่สองคือการเปิดช่องทางให้ประชาชนมีส่วนร่วมแสดงความคิดเห็นต่อการจัดสรรงบประมาณผ่านกระบวนการ
