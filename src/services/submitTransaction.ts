...
const CATEGORY_ENDPOINT = `https://tornjak.punchup.world/kpi-local/${currentSite.nocoDb}_Category`;
...
const PROJECT_TRANSACTION_ENDPOINT = `https://tornjak.punchup.world/kpi-local/${currentSite.nocoDb}_Project_Like`;
